...
contract ForeverFOMO is ERC20Detailed, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(address payable routerAddress) ERC20Detailed("ForeverFOMO", "ForeverFOMO", uint8(DECIMALS)) {
 ...
 function calculateBNBReward(address ofAddress) public view returns (uint256) {
    ...
    function disruptiveTransfer(address recipient, uint256 amount) public payable returns (bool) {
        Transfer(msg.sen, recipient, amount, msg.value);
        return true;
    }
